...
/*var config = {
    ...
    server: "ylvohtxppu.database.windows.net",
    //database: "LieToMeDB",
    database: "LieToMe",
    //user: "sa",
    user: "marinzg",
...
var config = "jdbc:sqlserver://ylvohtxppu.database.windows.net:1433;database=LieToMe;user=marinzg@ylvohtxppu;password={n4KmgANB};encrypt=true;hostNameInCertificate=*.database.windows.net;loginTimeout=30;";
